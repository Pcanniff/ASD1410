...
@interface Canniff_Philip_ProjectOne1410Object : KrollCoverageObject {
#else
@interface Canniff_Philip_ProjectOne1410Object : KrollObject {
#endif
@private
...
extern NSString * Canniff_Philip_ProjectOne1410$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Canniff_Philip_ProjectOne1410Object *_canniff_philip_projectone1410;
    KrollObject* console;
	BOOL shutdown;
