...
/**
 Base class for all Canniff_Philip_ProjectOne1410 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Canniff_Philip_ProjectOne1410 view hierarchy (such as wrapped iOS UIViews) was touched.
