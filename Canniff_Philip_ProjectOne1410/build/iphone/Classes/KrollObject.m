...
//@interface Canniff_Philip_ProjectOne1410Object : NSObject
//@end

@interface Canniff_Philip_ProjectOne1410Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Canniff_Philip_ProjectOne1410Object class]])
		{
			for (NSString *key in [[(Canniff_Philip_ProjectOne1410Object*)o modules] allKeys])
			{
