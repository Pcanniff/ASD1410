...
//Rare exceptions to indicate a bug in the _canniff_philip_projectone1410 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Canniff_Philip_ProjectOne1410 proxies.
 */
