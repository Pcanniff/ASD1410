...
@interface Canniff_Philip_ProjectTwo1410Object : KrollCoverageObject {
#else
@interface Canniff_Philip_ProjectTwo1410Object : KrollObject {
#endif
@private
...
extern NSString * Canniff_Philip_ProjectTwo1410$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Canniff_Philip_ProjectTwo1410Object *_canniff_philip_projecttwo1410;
    KrollObject* console;
	BOOL shutdown;
