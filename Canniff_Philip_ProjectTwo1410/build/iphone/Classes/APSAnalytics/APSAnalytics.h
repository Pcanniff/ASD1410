 ...
 * to send analytic data that can be viewed on the Canniff_Philip_ProjectTwo1410 Dashboard.
 *
 * For information on getting started with Canniff_Philip_ProjectTwo1410 Platform Services,
