...
//Rare exceptions to indicate a bug in the _canniff_philip_projecttwo1410 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Canniff_Philip_ProjectTwo1410 proxies.
 */
