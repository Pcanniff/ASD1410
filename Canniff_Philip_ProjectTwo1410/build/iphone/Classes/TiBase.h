...
// in simulator we redefine to format for Canniff_Philip_ProjectTwo1410 Developer console
...
{\
	NSString * exceptionName = [@"org.canniff_philip_projecttwo1410." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.canniff_philip_projecttwo1410";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UICanniff_Philip_ProjectTwo1410NativeItemNone = -1, 
	UICanniff_Philip_ProjectTwo1410NativeItemSpinner = -2,
	UICanniff_Philip_ProjectTwo1410NativeItemProgressBar = -3,
	
	UICanniff_Philip_ProjectTwo1410NativeItemSlider = -4,
	UICanniff_Philip_ProjectTwo1410NativeItemSwitch = -5,
	UICanniff_Philip_ProjectTwo1410NativeItemMultiButton = -6,
	UICanniff_Philip_ProjectTwo1410NativeItemSegmented = -7,
	
	UICanniff_Philip_ProjectTwo1410NativeItemTextView = -8,
	UICanniff_Philip_ProjectTwo1410NativeItemTextField = -9,
	UICanniff_Philip_ProjectTwo1410NativeItemSearchBar = -10,
	
	UICanniff_Philip_ProjectTwo1410NativeItemPicker = -11,
	UICanniff_Philip_ProjectTwo1410NativeItemDatePicker = -12,
	
	UICanniff_Philip_ProjectTwo1410NativeItemInfoLight = -13,
	UICanniff_Philip_ProjectTwo1410NativeItemInfoDark = -14,
	
	UICanniff_Philip_ProjectTwo1410NativeItemDisclosure = -15,
	
	UICanniff_Philip_ProjectTwo1410NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Canniff_Philip_ProjectTwo1410 instances of
